...
from cs336_basics import tokeniser, transformer, training
...
def run_get_batch(
    ...
    """
    return training.get_batch(dataset, batch_size, context_length, device)
...
def run_gradient_clipping(parameters: Iterable[torch.nn.Parameter], max_l2_norm: float) -> None:
    ...
    """
    return training.grad_clip(parameters, max_l2_norm)
...
def run_get_lr_cosine_schedule(
    ...
    """
    return training.learning_rate_schedule(it, max_learning_rate, min_learning_rate, warmup_iters, cosine_cycle_iters)
...
def run_save_checkpoint(
    ...
    """
    training.save_checkpoint(model, optimizer, iteration, out)
...
def run_load_checkpoint(
    ...
    """
    return training.load_checkpoint(model, optimizer, src)
